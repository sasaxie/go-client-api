...
func (*InventoryItems) Descriptor() ([]byte, []int) {
	return fileDescriptor_TronInventoryItems_a1a6337ac56cf4db, []int{0}
}
...
func init() {
	proto.RegisterFile("core/TronInventoryItems.proto", fileDescriptor_TronInventoryItems_a1a6337ac56cf4db)
}

var fileDescriptor_TronInventoryItems_a1a6337ac56cf4db = []byte{
